...
class RecyclerViewAdapterInvoiceCustomerTeaCoffee(
    private val mList: List<UserModel>?
) :
    RecyclerView.Adapter<RecyclerViewAdapterInvoiceCustomerTeaCoffee.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        list1 = ArrayList()
        list1 = DatabaseClass.getDatabase(context)!!.dao!!.getCustomerData(Items.key)

        holder.tvCustomerName.text = Items.fname
        holder.tvCustomerType.text = Items.customerType
        ...
        if (list1!!.size > 0){
            ...
            holder.BtnGenerateInvoice.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View?) {
                    val intent = Intent(holder.itemView.context, InvoiceTeaInvoiceGenerateActivity::class.java)
